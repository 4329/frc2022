...
public class Limelight extends SubsystemBase {
    ...
    static NetworkTableEntry targetStatus;
    ...
    public Limelight() {
        ...
        targetStatus = Shuffleboard.getTab("RobotData").add("Target Acquired", status).getEntry();
    ...
    public static void limeLightStop() {
        NetworkTableInstance.getDefault().getTable("limelight").getEntry("<variablename>").setNumber(0);
    }

    public static boolean putTargetAcquired() {
        
        //true or false value
        if (checkTa() >= taTolerance) { //not getting anything from Ta
            status = true;
