...
//This section creates the widgets
    public void initSwerveAlignment(){
        if (!hasBeenInitialized) {//This prevents 2 sets of widgets from appearing when disabling & enabling the robot, causing a crash
            ...
            frontLeftAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FL Test Offset (d)",Math.toDegrees(frontLeftInitialAngle - m_dDrivetrain.getFrontLeftAngle() - DriveConstants.kFrontLeftOffset)).withPosition(0,1).withWidget(BuiltInWidgets.kTextView).getEntry();
            frontLeftAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FL Test Offset (r)",frontLeftInitialAngle - m_dDrivetrain.getFrontLeftAngle() - DriveConstants.kFrontLeftOffset).withPosition(1,1).withWidget(BuiltInWidgets.kTextView).getEntry();
            //Front right
            ...
            frontRightAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FR Test Offset (d)",Math.toDegrees(frontRightInitialAngle - m_dDrivetrain.getFrontRightAngle() - DriveConstants.kFrontRightOffset)).withPosition(3,1).withWidget(BuiltInWidgets.kTextView).getEntry();
            frontRightAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FR Test Offset (r)",frontRightInitialAngle - m_dDrivetrain.getFrontRightAngle() - DriveConstants.kFrontRightOffset).withPosition(4,1).withWidget(BuiltInWidgets.kTextView).getEntry();
            //Back left
            ...
            backLeftAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BL Test Offset (d)",Math.toDegrees(backLeftInitialAngle - m_dDrivetrain.getBackLeftAngle() - DriveConstants.kBackLeftOffset)).withPosition(0,3).withWidget(BuiltInWidgets.kTextView).getEntry();
            backLeftAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BL Test Offset (r)",backLeftInitialAngle - m_dDrivetrain.getBackLeftAngle() - DriveConstants.kBackLeftOffset).withPosition(1,3).withWidget(BuiltInWidgets.kTextView).getEntry();
            //Back right
            ...
            backRightAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BR Test Offset (d)",Math.toDegrees(backRightInitialAngle - m_dDrivetrain.getBackRightAngle() - DriveConstants.kBackRightOffset)).withPosition(3,3).withWidget(BuiltInWidgets.kTextView).getEntry();
            backRightAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BR Test Offset (r)",backRightInitialAngle - m_dDrivetrain.getBackRightAngle() - DriveConstants.kBackRightOffset).withPosition(4,3).withWidget(BuiltInWidgets.kTextView).getEntry();
        }
    }
//This section constantly updates the values displayed in the widgets
    public void updateSwerveAlignment()
    {
        ...
        frontLeftAlignmentDisplayDeg.setDouble(Math.toDegrees(frontLeftInitialAngle - m_dDrivetrain.getFrontLeftAngle() - DriveConstants.kFrontLeftOffset));
        frontLeftAlignmentDisplayRad.setDouble(frontLeftInitialAngle - m_dDrivetrain.getFrontLeftAngle() - DriveConstants.kFrontLeftOffset);
        //Front right
        ...
        frontRightAlignmentDisplayDeg.setDouble(Math.toDegrees(frontRightInitialAngle - m_dDrivetrain.getFrontRightAngle() - DriveConstants.kFrontRightOffset));
        frontRightAlignmentDisplayRad.setDouble(frontRightInitialAngle - m_dDrivetrain.getFrontRightAngle() - DriveConstants.kFrontRightOffset);
        //Back left
        ...
        backLeftAlignmentDisplayDeg.setDouble(Math.toDegrees(backLeftInitialAngle - m_dDrivetrain.getBackLeftAngle() - DriveConstants.kBackLeftOffset));
        backLeftAlignmentDisplayRad.setDouble(backLeftInitialAngle - m_dDrivetrain.getBackLeftAngle() - DriveConstants.kBackLeftOffset);
        //Back right
        ...
        backRightAlignmentDisplayDeg.setDouble(Math.toDegrees(backRightInitialAngle - m_dDrivetrain.getBackRightAngle() - DriveConstants.kBackRightOffset));
        backRightAlignmentDisplayRad.setDouble(backRightInitialAngle - m_dDrivetrain.getBackRightAngle() - DriveConstants.kBackRightOffset);
    }
}
