...
public class SwerveAlignment {
    ...
    public void initSwerveAlignmentWidgets(){
        ...
        frontLeftAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FL Test Offset (d)",Math.toDegrees(m_dDrivetrain.getFrontLeftAngle() - frontLeftInitialAngle)).withPosition(0,1).withWidget(BuiltInWidgets.kTextView).getEntry();
        frontLeftAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FL Test Offset (r)",m_dDrivetrain.getFrontLeftAngle() - frontLeftInitialAngle).withPosition(1,1).withWidget(BuiltInWidgets.kTextView).getEntry();
        //Front right
        ...
        frontRightAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FR Test Offset (d)",Math.toDegrees(m_dDrivetrain.getFrontRightAngle() - frontRightInitialAngle)).withPosition(3,1).withWidget(BuiltInWidgets.kTextView).getEntry();
        frontRightAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("FR Test Offset (r)",m_dDrivetrain.getFrontRightAngle() - frontRightInitialAngle).withPosition(4,1).withWidget(BuiltInWidgets.kTextView).getEntry();
        //Back left
        ...
        backLeftAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BL Test Offset (d)",Math.toDegrees(m_dDrivetrain.getBackLeftAngle() - backLeftInitialAngle)).withPosition(0,3).withWidget(BuiltInWidgets.kTextView).getEntry();
        backLeftAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BL Test Offset (r)",m_dDrivetrain.getBackLeftAngle() - backLeftInitialAngle).withPosition(1,3).withWidget(BuiltInWidgets.kTextView).getEntry();
        //Back right
        ...
        backRightAlignmentDisplayDeg = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BR Test Offset (d)",Math.toDegrees(m_dDrivetrain.getBackRightAngle() - backRightInitialAngle)).withPosition(3,3).withWidget(BuiltInWidgets.kTextView).getEntry();
        backRightAlignmentDisplayRad = Shuffleboard.getTab(SWERVE_ALIGNMENT).add("BR Test Offset (r)",m_dDrivetrain.getBackRightAngle() - backRightInitialAngle).withPosition(4,3).withWidget(BuiltInWidgets.kTextView).getEntry();
    }
    ...
    public void updateSwerveAlignment()
    {
        ...
        frontLeftAlignmentDisplayDeg.setDouble(Math.toDegrees(m_dDrivetrain.getFrontLeftAngle() - frontLeftInitialAngle));
        ...
        frontRightAlignmentDisplayDeg.setDouble(Math.toDegrees(m_dDrivetrain.getFrontRightAngle() - frontRightInitialAngle));
        ...
        backRightAlignmentDisplayDeg.setDouble(Math.toDegrees(m_dDrivetrain.getBackRightAngle() - backRightInitialAngle));
