...
public class RejectAutoHigh extends SequentialCommandGroup{
    ...
    public RejectAutoHigh(Drivetrain drive, IntakeMotor intakeMotor,StorageIntake storageIntake,ShooterFeedSubsytem shooterFeed,Shooter shooter, TurretSubsystem turretSubsystem, HoodSubsystem hoodSubsystem, IntakeSolenoidSubsystem intakeSolenoid, IntakeSensors intakeSensors) {
        ...
        Command intakeReverse = new AllBackwardsCommand(shooterFeed, storageIntake, intakeMotor);
        ...
        addCommands(
            ...
            intakePosCommand,
            new ParallelCommandGroup(intakeRun, RejectHigh1).withTimeout(2), 
            groups.fire(turretSubsystem, storageIntake, shooterFeed, shooter, hoodSubsystem).withTimeout(2),
            new ParallelCommandGroup(intakeRun2, RejectHigh2).withTimeout(6),
            RejectHigh3,
            intakeReverse.withTimeout(2),
            intakePosCommand2,
            RejectHigh4
            );
    }
