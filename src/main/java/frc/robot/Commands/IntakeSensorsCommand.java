...
public class IntakeSensorsCommand extends CommandBase {
    ...
    public IntakeSensorsCommand(IntakeSensors intakeSensors, ShooterFeedSubsytem shooterFeed, StorageIntake storageIntake, IntakeMotor intakeMotor, IntakeSolenoidSubsystem intakeSolenoid) {
